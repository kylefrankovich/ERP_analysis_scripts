...
old_analysis_date = '06_28_16'; % 6/23/16 needs the "old_analysis" folder below; later comparisons probably won't
sub_folder_old_analysis_06_28 = fullfile(ERP_data_folder, 'archived_data_analysis/', old_analysis_date, sub_to_process, '/');
...
ERP = pop_loaderp( 'filename', [cur_sub '_LOTP_4AFC_ERP2_ERP_contra_ipsi_diff_blocked_mixed.erp'], 'filepath', char(sub_folder_old_analysis_pre_06_23) );
% ERP = pop_ploterps( ERP, [ 5 6],33 , 'AutoYlim', 'on', 'Axsize', [ 0.05 0.08], 'BinNum', 'on', 'Blc', 'pre', 'Box', 
%5 [ 6 6], 'ChLabel', 'on', 'FontSizeChan',10, 'FontSizeLeg',12, 'FontSizeTicks',10, 'LegPos', 'bottom', 'Linespec', 
%{'k-' , 'r-' }, 'LineWidth',1, 'Maximize', 'on', 'Position', [ 103.667 29.6364 107 32], 'Style', 'Classic', 'Tag', 'ERP_figure', 'Transparency',0, 
%'xscale', [ -200.0 698.0 -200:100:600 ], 'YDir', 'normal' );
% from Jackie:
...
% all bins (06_28_16 analysis (weird waveforms due to incorrectly collapsed bins)):

fprintf('\n******\nProcessing subject %s\n******\n\n', sub_to_process);
% for subjects w/ mixed: '_LOTP_4AFC_ERP2_ERP_contra_ipsi_diff_blocked_mixed.erp'
% w/o mixed: '_LOTP_4AFC_ERP2_ERP_contra_ipsi_diff.erp'
ERP = pop_loaderp( 'filename', [cur_sub '_LOTP_4AFC_ERP2_ERP_contra_ipsi_diff_blocked_mixed.erp'], 'filepath', char(sub_folder_old_analysis_06_28) );
ERP = pop_ploterps( ERP, [ 1 2],  1:11 , 'AutoYlim', 'on', 'Axsize', [ 0.05 0.08], 'BinNum', 'on', 'Blc', 'pre', 'Box', [ 4 3], 'ChLabel',...
 'on', 'FontSizeChan',  10, 'FontSizeLeg',  12, 'FontSizeTicks',  10, 'LegPos', 'bottom', 'Linespec', {'k-' , 'r-' }, 'LineWidth',  1, 'Maximize',...
 'on', 'Position', [ 103.714 29.6429 106.857 31.9286], 'Style', 'Classic', 'Tag', 'ERP_figure', 'Transparency',  0, 'xscale',...
 [ -200.0 698.0   -200:100:600 ], 'YDir', 'normal' );
